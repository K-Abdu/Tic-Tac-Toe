...
const cellClick = (i) => {
  ...
  if (gameStatus === true || classList[2] !== 'x' && classList[2] !== '0') {
    indexOfCell = emptyCells.indexOf(location);
...
const bestMove = () => {
  ...
  emptyCells[bestMove.i][bestMove.j] = ai;
  xNext
}
